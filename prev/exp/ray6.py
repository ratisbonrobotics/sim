...
# XML description for a 2 DOF ball model
xml_2dof = """
...
# Add obstacles to the XML model
...
# Create mujoco-x data structures
...
# Distance and geometry computation
dist, geom = f_mray(mx, dx, dx.cam_xpos[0], vecs_gf)

# Simulation and rendering setup
num_envs = 8000
